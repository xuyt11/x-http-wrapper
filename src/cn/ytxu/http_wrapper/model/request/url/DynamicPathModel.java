 ...
 */
public class DynamicPathModel extends BaseModel<RequestUrlModel> {
    ...
    public DynamicPathModel(RequestUrlModel higherLevel, String param, String realParam, int paramIndex, int start, int end) {
        super(higherLevel);
        this.param = param;
        ...
        this.start = start;
        this.end = end;
        higherLevel.addDynamicPath(this);
    }
    ...
    public String url_path_dynamic_param() {
        int indexOfParams = paramIndex;// getHigherLevel().getDynamicPaths().indexOf(this);
